function [E,F]=det_truncated_CG(U,fun,delta,A,N,I)
...
[E_H,F_H]=det_Hessian_expresion(U,Ubot,delta_e,delta_f,A,N,I);
...
for itr = 1 : 100
    ...
    %H_delta_phi_norm=real(sum(dot(E_H*delta_e,delta_e,1))+sum(dot(F_H*delta_f,delta_f,1)));
